...
const stepNamesMap: { [key: number]: string } = {
  ...
  3: i18n.translate('xpack.idxMgmt.templateForm.steps.settingsStepName', {
    defaultMessage: 'Index settings',
  }),
  4: i18n.translate('xpack.idxMgmt.templateForm.steps.mappingsStepName', {
    defaultMessage: 'Mappings',
  }),
  5: i18n.translate('xpack.idxMgmt.templateForm.steps.aliasesStepName', {
    defaultMessage: 'Aliases',
  }),
  6: i18n.translate('xpack.idxMgmt.templateForm.steps.summaryStepName', {
